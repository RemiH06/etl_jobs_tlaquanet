...
with DAG(
    ...
    run_spark_etl = DockerOperator(
        ...
        force_pull=False,
        mount_tmp_dir=False,
        command='/opt/spark/bin/spark-submit --packages org.postgresql:postgresql:42.7.1,net.snowflake:spark-snowflake_2.12:3.1.7,net.snowflake:snowflake-jdbc:3.15.0 /app/spark_job_all_tables.py'
    )
